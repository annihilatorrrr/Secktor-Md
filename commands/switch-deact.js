...
cmd(
	...
	async (Void, citel, text, { isCreator }) => {
		...
		//-----------------------------------------
		if (!citel.isGroup)
			return citel.reply('This feature in only for Group.');
		if (!text)
			return citel.reply(
			...
			case 'antilink':
				{
					...
					if (!checkgroup) {
						...
						return citel.reply(
							' Antilink disabled Successfully',
						);
					} else {
						if (checkgroup.antilink == 'false')
							return citel.reply(
								'Antilink was alredy disabled.',
							);
						await sck.updateOne(
							{ id: citel.chat },
							{ antilink: 'false' },
			...
			case 'economy':
				{
					...
					if (!checkgroup) {
						...
						return citel.reply(
							' Economy disabled Successfully',
						);
					} else {
						if (checkgroup.economy == 'false')
							return citel.reply(
								'Economy was alredy disabled.',
							);
						await sck.updateOne(
							{ id: citel.chat },
							{ economy: 'false' },
			...
			case 'events':
				{
					...
					if (!checkgroup) {
						...
						return citel.reply(
							'Successfully disabled *Events*',
						);
					} else {
						if (checkgroup.events == 'false')
							return citel.reply(
								'*Events* are already disabled',
							);
						await sck.updateOne(
							{ id: citel.chat },
							{ events: 'false' },
			...
			case 'cardgame':
				{
					...
					if (!checkgroup) {
						...
						return citel.reply(
							'Successfully disabled *Card Game*',
						);
					} else {
						if (checkgroup.cardgame == 'deactive')
							return citel.reply(
								'*Card Game* was already disabled',
							);
						await sck.updateOne(
							{ id: citel.chat },
							{ cardgame: 'deactive' },
			...
			case 'nsfw':
				{
					...
					if (!checkgroup) {
						...
						return citel.reply(
							'Successfully disabled *NSFW*',
						);
					} else {
						if (checkgroup.nsfw == 'false')
							return citel.reply(
